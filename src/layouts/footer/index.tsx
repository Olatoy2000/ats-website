    ...
    <Container className="bg-black grid grid-cols-4 p-12 gap-12">
      <article className="flex flex-col gap-4">
        ...
        <p className="font-normal leading-6 text-white">
          AFEX Tech Hub. Christiana Oyinade House, Beside First Bank, Iwo Road,
          Ibadan.
        </p>
          ...
          <ul className="flex gap-6 justify-between">
            ...
            <li>
              <a href="https://www.facebook.com/profile.php?id=100046536650064">
                <img src={FaceBook.src} alt="Instagram Logo" className="w-10" />
              </a>
            </li>
            <li>
              <a href="https://www.linkedin.com/company/afex-commodities-exchange">
                <img src={LinkedIn.src} alt="Instagram Logo" className="w-10" />
              </a>
            </li>
            <li>
              <a href="https://twitter.com/AFEXNigeria">
                <img src={Twitter.src} alt="Instagram Logo" className="w-10" />
              </a>
            </li>
          </ul>
        </div>
