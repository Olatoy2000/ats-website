...
import { NewsSearchSample, decrypt } from "./library";

export function NewsSearchDisplay(
	props: NewsSearchSample["data"]["hits"][number]
) {
	return (
		<div className='flex flex-col pb-4 shadow rounded-md'>
			...
			<Link href={`/news/${decrypt(props.objectID)}`}>
