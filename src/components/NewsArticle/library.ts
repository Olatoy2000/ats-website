...
export type NewsSample = typeof newsSample;
...
export function isNewsSample(value?: NewsQuery): value is NewsSample {
	return value ? Object.hasOwn(value?.data, "results") : false;
}

export type NewsSearchSample = typeof newsSearchSample;

export type NewsQuery = NewsSample | NewsSearchSample;
