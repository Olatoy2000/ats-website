...
import MobileAppBack from "../modals/assets/mobileback.png";
import moment from "moment";
import setupthree from "./setupthree.json";
  ...
  return (
    <Fragment>
      ...
      <article className="flex flex-col gap-6 p-10">
        ...
        <p className="text-justify">{setupthree.data.description}</p>
        <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-4 justify-start mb-6">
            <h5 className="font-bold">
              ...
              <span className="font-light">
                {setupthree.data.active_cohort.name}
              </span>
            </h5>
            <h5 className="font-bold">
              Starting Date:{" "}
              <span className="font-light">
                {moment(setupthree.data.active_cohort.start_date).format("LL")}
              </span>
            </h5>
            <h5 className="font-bold">
              Ending Date:
              <span className="font-normal">
                {moment(setupthree.data.active_cohort.end_date).format("LL")}
              </span>
            </h5>
          </div>
        </div>
        ...
        <div>
          <div className="flex flex-col gap-4 justify-start mb-6">
            <h5 className="font-bold">
              Cohort:{" "}
              <span className="font-normal">{setupthree.data.job.cohort}</span>
            </h5>
            <h5 className="font-bold">
              Starting Date:{" "}
              <span className="font-normal">
                {moment(setupthree.data.job.start_date).format("LL")}
              </span>
            </h5>
            <h5 className="font-bold">
              Ending Date:{" "}
              <span className="font-normal">
                {moment(setupthree.data.job.end_date).format("LL")}
              </span>
            </h5>
            <h5 className="font-bold">
              Application Starting Date:{" "}
              <span className="text-bold-malachite text-bold">
                {moment(setupthree.data.job.application_start_date).format(
                  "LL"
                )}
              </span>
            </h5>
            <h5 className="font-bold">
              ...
              <span className="text-light-internationalOrange text-bold">
                {moment(setupthree.data.job.application_end_date).format("LL")}
              </span>
            </h5>
          </div>
        </div>
