...
import FrontEndBack from "../modals/assets/frontendback.png";
import moment from "moment";
import setuptwo from "./setuptwo.json";
      ...
      <article className="flex flex-col gap-6 p-10">
          ...
          <div className="flex flex-col gap-4 justify-start mb-6">
            <h5 className="font-bold">
              ...
              <span className="font-light">
                {setuptwo.data.active_cohort.name}
              </span>
            </h5>
            <h5 className="font-bold">
              Starting Date:{" "}
              <span className="font-light">
                {moment(setuptwo.data.active_cohort.start_date).format("LL")}
              </span>
            </h5>
            <h5 className="font-bold">
              Ending Date:
              <span className="font-normal">
                {moment(setuptwo.data.active_cohort.end_date).format("LL")}
              </span>
            </h5>
          </div>
        </div>
        ...
        <div>
          <div className="flex flex-col gap-4 justify-start mb-6">
            <h5 className="font-bold">
              Cohort:
              <span className="font-normal">{setuptwo.data.job.cohort}</span>
            </h5>
            <h5 className="font-bold">
              Starting Date:{" "}
              <span className="font-normal">
                {moment(setuptwo.data.job.start_date).format("LL")}
              </span>
            </h5>
            <h5 className="font-bold">
              Ending Date:{" "}
              <span className="font-normal">
                {moment(setuptwo.data.job.end_date).format("LL")}
              </span>
            </h5>
            <h5 className="font-bold">
        ...
        <a href={setuptwo.data.job.apply_link}>
          <button
            id="app"
