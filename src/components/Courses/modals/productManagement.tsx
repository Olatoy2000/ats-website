        ...
        <Fragment>
                ...
                <section className="flex flex-col items-center gap-1">
                    ...
                    <div className="flex items-center gap-1">
                        <Icon
                            ...
                            color={
                                +moment(
                                    setup.data.job.application_end_date
                                ).format("x") -
                                    +moment().format("x") >
                                0
                                    ? "#00ff38"
            ...
            <article className="flex flex-col gap-6 p-10">
                <div className="flex flex-col gap-1">
                    <h3 className="text-light-quickSilver uppercase">
                        course detail
                    </h3>
                    <Divider />
                </div>
                ...
                <div>
                    <div className="flex flex-col gap-4 justify-start mb-6">
                        ...
                        <h5 className="font-bold">
                            ...
                            <span className="font-light">
                                {moment(
                                    setup.data.active_cohort.start_date
                                ).format("LL")}
                            </span>
                        </h5>
                        <h5 className="font-bold">
                            ...
                            <span className="font-normal">
                                {moment(
                                    setup.data.active_cohort.end_date
                                ).format("LL")}
                            </span>
                        </h5>
                    </div>
                ...
                <div className="flex flex-col gap-1">
                    <h3 className="uppercase text-light-darkSilver">
                        open application
                    </h3>
                    <Divider />
                </div>
                    ...
                    <div className="flex flex-col gap-4 justify-start mb-6">
                        ...
                        <h5 className="font-bold">
                            ...
                            <span className="text-bold-malachite font-bold">
                                {moment(
                                    setup.data.job.application_start_date
                                ).format("LL")}
                            </span>
                        </h5>
                        <h5 className="font-bold">
