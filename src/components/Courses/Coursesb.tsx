        ...
        <div className="pt-24">
            <div className="flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-center w-2/3 sm:w-3/4 lg:text-lg md:text-base text-xs">
                    ...
                    refuse to confine themselves. That's why at AFEX we do not
                    ask "why" but rather "why not". Through our ATS program, we
                    aspire to build an ecosystem of tech stars with the skills
                    and mindset needed to thrive now and in the future
                </p>
            </div>
