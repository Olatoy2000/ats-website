...
function ApplyNow() {
	return (
		<div className='bg-[#F9E3E3] py-14 flex flex-col rounded-lg justify-center items-center mb-10'>
			<p className='text-[#222222] font-semibold lg:text-xl md:text-xs pb-5'>
