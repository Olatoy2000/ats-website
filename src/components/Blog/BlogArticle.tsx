			...
			<div className='grid gap-8 grid-cols-3 grid-rows-4'>
				<div className='flex-col shadow-xl md:w-96'>
					...
					<p className='text-[#718096] text-sm md:px-4'>
						Eleni Gabre-Madhin established the first commodity exchange in
						Africa following a famine in her home country, Ethiopia, in 2002...
					</p>
					<div className='flex gap-3 md:pt-10 items-center md:md:px-4'>
						<img
							src={MyImage2.src}
							className='h-10'
						/>
				...
				<div className='flex-col shadow-xl md:md:w-96'>
					<img
						src={MyImage.src}
						className='object-cover md:w-full'
					/>
					...
					<div className='flex gap-3 md:pt-10 items-center md:p-5 md:px-4'>
						<img
							src={MyImage2.src}
							className='h-10'
						/>
